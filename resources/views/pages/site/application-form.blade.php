                    ...
                    <div class="row align-items-center justify-content-lg-between justify-content-center gy-4">
                        <div class="col-lg-5 col-sm-7">
                            <div class="about-img-section mb-5 mb-lg-0 text-center">
                                ...
                                <img src="{{ URL::asset('build/images/about.jpg') }}" alt=""
                                    class="img-fluid mx-auto rounded-3" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="text-muted">
                                <h1 class="mb-3 lh-base fw-semibold">Find Your <span class="text-primary">Dream Job</span>
                                    in One Place</h1>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-7">
                            <div class="text-center mb-5">
                                ...
                                <p class="text-muted">Post a job to tell us about your project. We'll quickly match you
                    ...
                    <div class="row">
                                    ...
                                    <div class="d-flex">
                                        <div class="avatar-sm">
                                            <div class="avatar-title bg-success-subtle rounded">
                                                <img src="{{ URL::asset('build/images/companies/img-9.png') }}"
                                                    alt="" class="avatar-xxs">
                                            </div>
                                        </div>
                                        <div class="ms-3 flex-grow-1">
                            ...
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="avatar-sm">
                                            <div class="avatar-title bg-success-subtle rounded">
                                                <img src="{{ URL::asset('build/images/companies/img-7.png') }}"
                                                    alt="" class="avatar-xxs">
                                            </div>
                                        </div>
                                        <div class="ms-3 flex-grow-1">
                        ...
                        <div class="col-lg-12">
                            <div class="text-center mt-4">
                                <a href="#!" class="btn btn-ghost-primary shadow-none">View More Jobs <i
                    ...
                    <div class="row align-items-center gy-4">
                        <div class="col-lg-6 order-2 order-lg-1">
                            <div class="text-muted mt-5 mt-lg-0">
                                ...
                                <div class="mt-4">
                                    <a href="index" class="btn btn-primary">View More Companies <i
                                        ...
                                        <div class="card text-center">
                                            <div class="card-body p-4">
                                                <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}"
                                                    alt="" class="rounded-circle avatar-md mx-auto d-block">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-muted fs-14">Intrinsically incubate intuitive opportunities and
