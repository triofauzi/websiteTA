<div class="modal flip" id="paymentProcessModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                        ...
                        <div class="row">
                            <div class="form-group col-12">
                                ...
                                <select name="period" id="period" data-choices class="form-select">
                                    ...
                                    @foreach (\App\Models\PayrollPeriod::orderBy('pay_date', 'desc')->get() as $payPeriod)
                                        <option value="{{ $payPeriod->id }}">{{ $payPeriod->period_code }}</option>
                                    @endforeach
                                </select>
                            </div>
